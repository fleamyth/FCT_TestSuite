...
CALL :START_GRR_UPLOAD_AND_WAIT_DUT_DISCONNECT
GOTO jigup
...
:START_GRR_UPLOAD_AND_WAIT_DUT_DISCONNECT
START "" /B CMD.EXE /D /C ""%~f0" __UPLOAD_GRR_WORKER >nul 2>&1"
...
CALL "%GOOGLE_DRIVE_UPLOAD_BAT%" "%LOG_ROOT%\%LOG_IDENTIFIER%" "%GOOGLE_DRIVE_URL%" "gdrive" "%GOOGLE_DRIVE_DATE%/%LOG_IDENTIFIER%"
...
CALL "%GOOGLE_DRIVE_UPLOAD_BAT%" "%GOOGLE_DRIVE_STAGE%" "%GOOGLE_DRIVE_URL%" "gdrive" "%GOOGLE_DRIVE_DATE%/%LOG_IDENTIFIER%"
IF %ERRORLEVEL% NEQ 0 SET "GOOGLE_DRIVE_UPLOAD_FAILED=1"
