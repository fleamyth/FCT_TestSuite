...
# 設定多個例外清單
$exceptionList = @("Unknown USB Device (Set Address Failed)","Surface Battery Miniport Adapter", "Surface Camera Front", "Surface Camera Rear", "Surface IR Camera Front", "Surface Digitizer WoT Extn Package", "MPTF Thermal Policy Driver", "MPTF Core", "Surface Touch Screen Device")
